...
<body>
    ...
    <div id="landingScreen" class="landing-screen">
        ...
        <header class="landing-header">
            ...
            <ul class="top-nav-links landing-nav-links">
                ...
                <li class="nav-dropdown nav-dropdown-pin" id="categoriesDropdown">
                    <a href="#" class="nav-dropdown-toggle" aria-expanded="false" aria-haspopup="true">Cat?gories <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg></a>                    <ul class="nav-dropdown-menu">
        ...
        <div class="landing-body">
            <div class="landing-hero-text">
                <h1>Sweet Austria</h1>
                <p>La plateforme la plus proche des go?ts de luxe</p>
            </div>
        ...
        <div class="landing-footer">? 2026 A2S ? Tous Droits R?serv?s</div>
    </div>
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-group">
                ...
                <ul class="nav-submenu">
                    ...
                    <li><a href="#" class="nav-subitem"><span class="nav-subicon" aria-hidden="true"><svg viewBox="0 0 24 24"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg></span>R?glement Achats</a></li>
                    ...
                    <li><a href="#" class="nav-subitem"><span class="nav-subicon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg></span>Relev? Compte Frns</a></li>
                </ul>
            </div>
            ...
            <div class="nav-group">
                ...
                <ul class="nav-submenu">
                    ...
                    <li><a href="#" class="nav-subitem"><span class="nav-subicon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg></span>D?p?t Produits Crus</a></li>
                    <li><a href="#" class="nav-subitem"><span class="nav-subicon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg></span>D?p?t Produits Finis</a></li>
                    <li><a href="#" class="nav-subitem"><span class="nav-subicon" aria-hidden="true"><svg viewBox="0 0 24 24"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/><line x1="12" y1="12" x2="12" y2="16"/></svg></span>D?p?t Produits Divers</a></li>
                </ul>
            </div>
            ...
            <div class="nav-group">
                ...
                <ul class="nav-submenu">
                    <li><a href="#" class="nav-subitem"><span class="nav-subicon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M12 20V10"/><path d="M18 20V4"/><path d="M6 20v-4"/></svg></span>?tat Journalier Quantit?</a></li>
                    <li><a href="#" class="nav-subitem"><span class="nav-subicon" aria-hidden="true"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg></span>?tat Journalier Production</a></li>
                    <li><a href="#" class="nav-subitem"><span class="nav-subicon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12h14"/><path d="M12 5l7 7-7 7"/></svg></span>?tat Journalier Sortie</a></li>
                    <li><a href="#" class="nav-subitem"><span class="nav-subicon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M12 1v22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg></span>?tat Journalier D?pense</a></li>
                </ul>
            </div>
            ...
            <div class="nav-group">
                ...
                <ul class="nav-submenu">
                    <li><a href="#" class="nav-subitem"><span class="nav-subicon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg></span>?tat Achats</a></li>
                    <li><a href="#" class="nav-subitem"><span class="nav-subicon" aria-hidden="true"><svg viewBox="0 0 24 24"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg></span>?tat Ventes</a></li>
                    <li><a href="#" class="nav-subitem"><span class="nav-subicon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg></span>?tat Stock</a></li>
                    <li><a href="#" class="nav-subitem"><span class="nav-subicon" aria-hidden="true"><svg viewBox="0 0 24 24"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg></span>?tat Paiement</a></li>
                </ul>
            </div>
    ...
    <div class="main-wrapper">
                            ...
                            <div class="tm-form-layout">
                                <div class="tm-form-fields">
                                    <div class="tm-inline-row tm-inline-row-1">
                                        ...
                                        <div class="form-group">
                                            <label for="tm_ref">R?f</label>
                                            <input type="text" id="tm_ref" name="ref" class="form-input" placeholder="R?f?rence" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="tm_designation">D?signation</label>
                                            <input type="text" id="tm_designation" name="designation" class="form-input" placeholder="D?signation du mat?riel" required>
                                        </div>
                                    </div>
                        ...
                        <div class="fournisseur-table-wrap">
                            <table class="fournisseur-table materiels-table" id="materielsTable">
                                ...
                                <tbody id="materielsTableBody">
                                    <tr><td colspan="9" class="fournisseur-empty">Aucun mat?riel enregistr?</td></tr>
                                </tbody>
                            </table>
                        </div>
                    </div>
        ...
        <footer class="page-footer">
            <span>? 2026 A2S ? Tous Droits R?serv?s</span>
    ...
    <script>
        ...
        function syncNavActive(viewId) {
            ...
            if (['achats', 'fiche-fournisseur', 'fiche-produit', 'fiche-societe', 'tresorerie-materiels', 'utilisateur'].includes(viewId)) {
                document.querySelectorAll('.nav-subitem.active').forEach(el => el.classList.remove('active'));
        ...
        function validateMaterielForm(data) {
            ...
            if (dup) {
                alert('Cette r?f?rence existe d?j?.');
                document.getElementById('tm_ref')?.focus();
                return false;
            }
            return true;
        ...
        function renderMaterielsTable() {
            ...
            if (!materiels.length) {
                materielsTableBody.innerHTML = '<tr><td colspan="9" class="fournisseur-empty">Aucun mat?riel enregistr?</td></tr>';
                return;
            }
        ...
        const AUTH_MENU_TREE = [
            ...
            },
            {
                ...
                items: [
                    ...
                    { id: 'fournisseur.reglement', label: 'Règlement Achats' },
                    { id: 'fournisseur.balance', label: 'Balance Achats' },
                    { id: 'fournisseur.releve', label: 'Relevé Compte Frns' }
                ]
            },
            {
                id: 'stock',
            ...
            },
            {
                ...
                label: 'Production',
                items: [
                    { id: 'production.qte', label: 'État Journalier Quantité' },
                    { id: 'production.prod', label: 'État Journalier Production' },
                    { id: 'production.sortie', label: 'État Journalier Sortie' },
                    { id: 'production.depense', label: 'État Journalier Dépense' }
                ]
            },
            {
                id: 'client',
            ...
            },
            {
                ...
                label: 'Rapport',
                items: [
                    { id: 'rapport.achats', label: 'État Achats' },
                    { id: 'rapport.ventes', label: 'État Ventes' },
                    { id: 'rapport.stock', label: 'État Stock' },
                    { id: 'rapport.paiement', label: 'État Paiement' }
                ]
            },
            {
                id: 'configuration',
